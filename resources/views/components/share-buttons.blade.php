<div class="fck-svp__sharebuttons mt-4 md:mt-8 grid grid-cols-1 gap-4">
    <a
    ...
    <a
        class="fcksvp-button flex justify-center items-center text-2xl gap-x-2 !bg-accent !no-underline !text-white"
